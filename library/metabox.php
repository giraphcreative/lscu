...
function page_metaboxes( $meta_boxes ) {
    ...
    $cmb_user->add_field( array(
        'name'     => __( 'Credit Union Info', 'cmb2' ),
        'desc'     => __( 'Manage the Credit Union Name and Charter ID for this user.', 'cmb2' ),
        'id'       => 'extra_info',
        'type'     => 'title',
        'on_front' => false,
    ) );
    $cmb_user->add_field( array(
        'name' => __( 'Credit Union Name', 'cmb2' ),
        'id'   => 'cu_name',
        'type' => 'text',
    ) );
    $cmb_user->add_field( array(
        'name' => __( 'Credit Union Charter ID', 'cmb2' ),
        'id'   => 'cu_charter_id',
        'type' => 'text',
    ) );
